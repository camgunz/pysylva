...
Array = TokenType('Array', {TokenCategory.Keyword})
...
CArray = TokenType('CArray', {TokenCategory.Keyword})
CBitField = TokenType('CBitField', {TokenCategory.Keyword})
CEnum = TokenType('CEnum', {TokenCategory.Keyword})
CFnType = TokenType('CFnType', {TokenCategory.Keyword})
CBlockFnType = TokenType('CBlockFnType', {TokenCategory.Keyword})
...
DoubleDot = TokenType('Dot', {TokenCategory.Symbol})
Dot = TokenType(
    'Dot',
    {TokenCategory.Symbol, TokenCategory.Operator},
